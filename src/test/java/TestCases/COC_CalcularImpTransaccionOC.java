...
public class COC_CalcularImpTransaccionOC{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_orden_compra\\dt_25169.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=25169)
    public void COC_CalcularImpTransaccionOC_25169() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "COC_CalcularImpTransaccionOC "+Repeticion;
                    ...
                    //Paso 11
                    contador++;
                    Pasos.add(contador+".-Ingresar informacion de documento");
