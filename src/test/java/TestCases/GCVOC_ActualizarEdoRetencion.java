...
public class GCVOC_ActualizarEdoRetencion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\gestionar_ciclo_vida_OC\\dt_25183.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=25183)
    public void GCVOC_ActualizarEdoRetencion_25183() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "GCVOC_ActualizarEdoRetencion "+Repeticion;
                    ...
                    lineasSteps.menuAccionesRetener(driver, UILineas, contador, Config, Escenario, Navegador);
