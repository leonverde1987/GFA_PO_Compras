...
public class MOC_CrearOrdenDeCambioDeOC{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\modificar_orden_compra\\dt_19615.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=19615)
    public void MOC_CrearOrdenDeCambioDeOC_19615() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "MOC_CrearOrdenDeCambioDeOC "+Repeticion;
                    ...
                    //Paso 4
                    contador++;
                    Pasos.add(contador+".- Seleccionar menú: Compras => Ordenes de compra ");
                    menusNavegadorSteps.abrirMenuOrdenesCompra(driver, UIMenusNavegador, contador, 
                    		Config, Escenario, Navegador);
                    
                    //Paso 5
                    contador++;
                    Pasos.add(contador+".-Seleccionar el buscador");
                    menuTareasSteps.clickBtnBusqueda(driver, UIMenuTareas,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 6
                    contador++;
                    Pasos.add(contador+".-Seleccionar concepto de busqueda");
                    menuTareasSteps.clickOpcFiltroBusqueda(driver, UIMenuTareas,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 7
                    contador++;
                    Pasos.add(contador+".-Ingresar Orden");
                    menuTareasSteps.ingresarOrden(driver, UIMenuTareas,
                    ...
                    menuTareasSteps.clickLupita2(driver, UIMenuTareas,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 9
                    contador++;
                    Pasos.add(contador+".-seleccionar acciones");
                    lineasSteps.menuAcciones(driver, UILineas,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 10
                    contador++;
                    Pasos.add(contador+".-seleccionar editar");
                    ...
                    //Paso 12
                    contador++;
                    Pasos.add(contador+".-seleccionar boton acciones");
                    cabeceraSteps.clickBtnAcciones(driver, UICabecera , 
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 13
                    contador++;
                    Pasos.add(contador+".-seleccionar boton validar");
                    ...
                    //Paso 15
                    contador++;
                    Pasos.add(contador+".-Seleccinar boton Enviar");
