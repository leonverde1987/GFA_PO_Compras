...
public class GCVOC_ActualizarEdoCongelacion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\gestionar_ciclo_vida_OC\\dt_25184.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=25184)
    public void GCVOC_ActualizarEdoCongelacion_25184() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String editDocGfaLiderCatego = filaDatos[7];
             ...
             try{
                    ...
                    Escenario = "GCVOC_ActualizarEdoCongelacion "+Repeticion;
                    ...
                    lineasSteps.menuAccionesCongelar(driver, UILineas, contador, Config, Escenario, Navegador);
