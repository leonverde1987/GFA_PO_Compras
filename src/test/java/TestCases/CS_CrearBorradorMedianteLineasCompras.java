...
public class CS_CrearBorradorMedianteLineasCompras{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_solicitud\\dt_15303.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=15303)
    public void CS_CrearBorradorMedianteLineasCompras_15303() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "CS_CrearBorradorMedianteLineasCompras "+Repeticion;
