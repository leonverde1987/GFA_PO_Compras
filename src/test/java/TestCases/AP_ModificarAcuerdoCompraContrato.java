...
public class AP_ModificarAcuerdoCompraContrato{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\acuerdos_proveedor\\dt_17312.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17312)
    public void AP_ModificarAcuerdoCompraContrato_17312() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "AP_ModificarAcuerdoCompraContrato "+Repeticion;
