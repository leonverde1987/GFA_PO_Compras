...
public class COC_ModificarOrdenConsignacion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_orden_compra\\dt_17354.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17354)
    public void COC_ModificarOrdenConsignacion_17354() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "COC_ModificarOrdenConsignacion "+Repeticion;
