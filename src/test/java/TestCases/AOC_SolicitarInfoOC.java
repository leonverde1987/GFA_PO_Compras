...
public class AOC_SolicitarInfoOC{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\aprobar_orden_compra\\dt_25179.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=25179)
    public void AOC_SolicitarInfoOC_25179() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String nombre = filaDatos[4];
            String comentario = filaDatos[4];
            String opcDevolucion = filaDatos[4];
            
             
    
            try{

                    Escenario = "AOC_SolicitarInfoOC "+Repeticion;
                    ...
                    contador++;
                    Pasos.add(contador+".- seleccionar el menu acciones ");
                    lineasSteps.menuAccionesSolicitarMasInfo(driver, UILineas,
                    		contador, Config, Escenario, Navegador);
