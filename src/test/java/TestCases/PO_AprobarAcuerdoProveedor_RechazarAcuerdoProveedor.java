...
public class PO_AprobarAcuerdoProveedor_RechazarAcuerdoProveedor{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\aprobar_acuerdo_proveedor\\dt_20163.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=20163)
    public void Test_PO_AprobarAcuerdoProveedor_RechazarAcuerdoProveedor() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    //Paso 5
                    contador++;
                    Pasos.add(contador+".- Presionar sobre el icono Agregar en la sección Comentarios.");
                    aprobacionSteps.clickIcnAgregarComentario(driver, UIAprobacion, contador, Config, Escenario, Navegador);
                    
                    //Paso 6
                    contador++;
                    Pasos.add(contador+".- Ingresar el Comentario.");
                    aprobacionSteps.ingresarComentario(driver, UIAprobacion, comentario, contador, Config, Escenario, Navegador);
                    
                    //Paso 7
                    contador++;
                    Pasos.add(contador+".- Presionar el botón Aceptar.");
                    aprobacionSteps.clickBtnAceptarComentario(driver, UIAprobacion, contador, Config, Escenario, Navegador);
                    
                    //Paso 8
                    contador++;
                    Pasos.add(contador+".- Presionar el botón Rechazar.");
                    aprobacionSteps.clickBtnRechazar(driver, UIAprobacion, contador, Config, Escenario, Navegador);
                    
                    //Paso 9
                    contador++;
                    Pasos.add(contador+".- Validar que se haya rechazado el Acuerdo.");
