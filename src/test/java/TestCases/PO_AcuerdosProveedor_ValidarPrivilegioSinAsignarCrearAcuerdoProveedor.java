...
public class PO_AcuerdosProveedor_ValidarPrivilegioSinAsignarCrearAcuerdoProveedor{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_orden_compra\\dt_16141.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=15737)
    public void Test_PO_AcuerdosProveedor_ValidarPrivilegioSinAsignarCrearAcuerdoProveedor() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "PO_AcuerdosProveedor_ValidarPrivilegioSinAsignarCrearAcuerdoProveedor "+Repeticion;
                    ...
                    //Paso 4
                    contador++;
                    Pasos.add(contador+".- Validar que no se muestre el menú Acuerdos de compra.");
                    Resultado = menusNavegadorSteps.validarInexistenciaMenu(driver, "Acuerdos de compra", Config, UIMenusNavegador, contador, Escenario, Navegador);
