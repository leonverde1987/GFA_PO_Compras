...
public class PO_AprobarOrdenCompra_AprobarOrdenCompraMayor100000Coma00LiderTecnico{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\aprobar_orden_compra\\dt_20638.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=20638)
    public void Test_PO_AprobarOrdenCompra_AprobarOrdenCompraMayor100000Coma00LiderTecnico() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "PO_Aprobar Orden de Compra_Aprobar una orden de compra mayor a 100000 coma 00 líder técnico "+Repeticion;
                    ...
                    //Paso 7
                    contador++;
                    Pasos.add(contador+".- Validar que se haya aprobado la Orden con el Líder Técnico.");
                    aprobacionSteps.clickNotificacionAcuerdoAprobacion(driver, UIAutoaprobacion, "Acción Necesaria: Aprobar "+tipoOrden+" "+numeroOrden, contador, Config, Escenario, Navegador);
                    genericSteps.switchWindowByIndex(driver, 1);
                    Resultado = aprobacionSteps.validarOrdenAprobadaLiderTecnico(driver, personaAsignada, Config, UIAprobacion, contador, Escenario, Navegador);
