...
public class PO_GestionarCicloVidaAcuerdoProveedor_RetirarAcuerdoProveedor{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\ciclo_vida_acuerdo_proveedor\\dt_25203.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=25203)
    public void Test_PO_GestionarCicloVidaAcuerdoProveedor_RetirarAcuerdoProveedor() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String mensajeConfirmacion = filaDatos[7];
            String estado = filaDatos[8];
            try{

                    Escenario = "PO_Gestionar el Ciclo de Vida de Acuerdo de Proveedor_Retirar acuerdo de proveedor "+Repeticion;
                    ...
                    //Paso 8
                    contador++;
                    Pasos.add(contador+".- Presionar sobre la opción Acciones - Cerrar definitivamente.");
                    gestionarAcuerdosSteps.presionarCerrarDefinitivamenteAcuerdo(driver, mensajeAdvertencia, UIGestionarAcuerdos, contador, Config, Escenario, Navegador);
                    
                    //Paso 9
                    contador++;
                    Pasos.add(contador+".- Presionar el botón Sí.");
                    gestionarAcuerdosSteps.confirmarCierreDefinitivoAcuerdo(driver, UIGestionarAcuerdos, contador, Config, Escenario, Navegador);
