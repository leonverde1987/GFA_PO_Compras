...
public class PO_AprobarOrdenCompra_RevisarDetalleSolicitudAprobacion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\aprobar_orden_compra\\dt_20172.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=20172)
    public void Test_PO_AprobarOrdenCompra_RevisarDetalleSolicitudAprobacion() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "PO_Aprobar Orden de Compra_Revisar detalle de solicitud de aprobación "+Repeticion;
