...
public class GCVOC_RetirarOrdenCompra{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\gestionar_ciclo_vida_OC\\dt_25186.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=25186)
    public void GCVOC_RetirarOrdenCompra_25186() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String editDocGfaLiderCatego = filaDatos[7];
             ...
             try{
                    ...
                    Escenario = "GCVOC_RetirarOrdenCompra "+Repeticion;
