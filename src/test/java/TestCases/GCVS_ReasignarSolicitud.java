...
public class GCVS_ReasignarSolicitud{
    ...
    public ReasignarSolicitudSteps reasignarSolicitudSteps = new ReasignarSolicitudSteps();
    ...
    public Properties UIReasignarSolicitud = null;
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        UIReasignarSolicitud = genericSteps.getPropetiesFile("configuracion\\uielements\\reasignarSolicitud.properties");
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\gestionar_ciclo_vida_solicitud\\dt_15376.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=15376)
    public void GCVS_ReasignarSolicitud_15376() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String reasignarA = filaDatos[5];
                                  
            
            try{

                    Escenario = "GCVS_ReasignarSolicitud "+Repeticion;
                    ...
                    contador++;
                    Pasos.add(contador+".- Seleccionar el boton ver ciclo de vida");
                    cabeceraSteps.clickBtnAccionesReasignar(driver, UICabecera, 
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 9
                    contador++;
                    Pasos.add(contador+".- ingresar nombre para reasignar");
                    reasignarSolicitudSteps.llenarFormReasignarSolicitud(driver, UIReasignarSolicitud,
                    		contador, Config, Escenario, Navegador, reasignarA);
                    
                    //Paso 10
                    contador++;
                    Pasos.add(contador+".- Seleccionar el boton aceptar");
                    reasignarSolicitudSteps.clickBtnAceptar(driver, UIReasignarSolicitud,
                    		contador, Config, Escenario, Navegador);
                     
                    //Paso 11
                    contador++;
                    Pasos.add(contador+".- Seleccionar boton aceptar confirmacion");
