...
public class AP_DarAltaAcuerdoCompraAbierto{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\acuerdos_proveedor\\dt_17306.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17306)
    public void AP_DarAltaAcuerdoCompraAbierto_17306() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "AP_DarAltaAcuerdoCompraAbierto "+Repeticion;
