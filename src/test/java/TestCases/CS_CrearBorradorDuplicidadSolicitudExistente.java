...
public class CS_CrearBorradorDuplicidadSolicitudExistente{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_solicitud\\dt_15310.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=15310)
    public void CS_CrearBorradorDuplicidadSolicitudExistente_15310() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "CS_CrearBorradorDuplicidadSolicitudExistente "+Repeticion;
                    ...
                    //Paso 8
                    contador++;
                    Pasos.add(contador+".- Seleccionar sobre la opcion Acciones => Duplicar");
                    lineasSteps.menuAccionesDuplicar(driver, UILineas,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 9
                    contador++;
                    Pasos.add(contador+".-Presionar Crear solicitudes nuevas");
                    lineasSteps.menuCrearSolicitudNuevaMsjInfo(driver, UILineas,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 10
                    contador++;
                    Pasos.add(contador+".-Presionar boton Guardar ");
