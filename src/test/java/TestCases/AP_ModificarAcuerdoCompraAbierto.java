...
public class AP_ModificarAcuerdoCompraAbierto{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\acuerdos_proveedor\\dt_17307.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17307)
    public void AP_ModificarAcuerdoCompraAbierto_17307() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "AP_ModificarAcuerdoCompraAbierto "+Repeticion;
