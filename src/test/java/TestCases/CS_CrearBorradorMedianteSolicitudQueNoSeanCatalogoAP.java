...
public class CS_CrearBorradorMedianteSolicitudQueNoSeanCatalogoAP{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_solicitud\\dt_15314.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=15314)
    public void CS_CrearBorradorMedianteSolicitudQueNoSeanCatalogoAP_15314() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "CS_CrearBorradorMedianteSolicitudQueNoSeanCatalogoAP "+Repeticion;
                   ...
                   //Paso 6
                    contador++;
                    Pasos.add(contador+".- Seleccionar opcion Solicitar Articulo no incluido en el catalogo");
                    solicitudesCompraSteps.clickOpcSolicitarArtNoIncluido(driver, UISolicitudesCompra, contador, Config, Escenario, Navegador);
