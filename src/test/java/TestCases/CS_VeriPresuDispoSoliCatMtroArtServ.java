...
public class CS_VeriPresuDispoSoliCatMtroArtServ{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_solicitud\\dt_20155.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=20155)
    public void CS_VeriPresuDispoSoliCatMtroArtServ_20155() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "CS_VeriPresuDispoSoliCatMtroArtServ "+Repeticion;
