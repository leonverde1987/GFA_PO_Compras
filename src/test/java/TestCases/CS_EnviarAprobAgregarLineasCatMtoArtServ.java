...
public class CS_EnviarAprobAgregarLineasCatMtoArtServ{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_solicitud\\dt_15323.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=15323)
    public void CS_EnviarAprobAgregarLineasCatMtoArtServ_15323() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "CS_EnviarAprobAgregarLineasCatMtoArtServ "+Repeticion;
                   ...
                   //Paso 10
                    ...
                    //Paso 11
                    contador++;
                    Pasos.add(contador+".- Seleccionar el boton enviar de la cabecera");
                    cabeceraSteps.clickBtnEnviar(driver, UICabecera,
                    		contador, Config, Escenario, Navegador);
                    
                    //Paso 12
                    contador++;
                    Pasos.add(contador+".- Seleccionar el boton Si del mensaje de confirmacion");
                    solicitudesCompraSteps.clickBtnSiMsj(driver, UISolicitudesCompra, contador, Config, Escenario, Navegador);
                    Resultado = "Exitoso";
