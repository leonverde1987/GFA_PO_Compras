...
public class COC_EnviarOrdenCompraApartirSolicitudParaAprobacion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_orden_compra\\dt_17339.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17339)
    public void COC_EnviarOrdenCompraApartirSolicitudParaAprobacion_17339() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "COC_EnviarOrdenCompraApartirSolicitudParaAprobacion "+Repeticion;
                    ...
                    //Paso 10
                    contador++;
                    Pasos.add(contador+".-Seleccionar menu editar");
                    lineasSteps.menuAccionesEditar(driver, UILineas, contador, Config, Escenario, Navegador);
                    
                    //Paso 11
                    contador++;
                    Pasos.add(contador+".-Seleccionar mboton enviar");
