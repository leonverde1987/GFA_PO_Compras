...
public class COC_DarAltaOrdenConsignacion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_orden_compra\\dt_17353.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17353)
    public void COC_DarAltaOrdenConsignacion_17353() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "COC_DarAltaOrdenConsignacion "+Repeticion;
