...
public class CS_DarAltaSolicitudAcuerdoProveedor{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\crear_solicitud\\dt_28232.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=28232)
    public void CS_DarAltaSolicitudAcuerdoProveedor_28232() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String articulo = filaDatos[5];
            String nombreUM = filaDatos[6];
            String precio = filaDatos[7];
            String moneda = filaDatos[8];
            String proveedor = filaDatos[9];
            String gfaSupervisor = filaDatos[10];
            String gfaLiderCategoria = filaDatos[11];
            String fechaEntrega = filaDatos[12];
            String tipoDestino = filaDatos[13];
            String subinventario = filaDatos[14];
           
            
            try{

                    Escenario = "CS_DarAltaSolicitudAcuerdoProveedor "+Repeticion;
                   ...
                   //Paso 7
                    ...
                    crearSolicitudNoIncluidaCatalogoSteps.llenarFormIntroducirLineaSoli(driver, UICrearSolicitudNoIncluidaCatalogo,
                    		contador, Config, Escenario, Navegador, tipoArticulo, articulo, 
                    		nombreUM, precio, moneda, proveedor);
                   
                    //Paso 8
                    contador++;
                    Pasos.add(contador+"Seleccionar la linea e ingresar la informacion en los campos");
                    lineasSteps.llenarFormDetallesLinea(driver, UILineas, contador, Config, Escenario, Navegador,
                    		fechaEntrega, tipoDestino, subinventario);
