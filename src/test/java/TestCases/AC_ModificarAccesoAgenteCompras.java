...
public class AC_ModificarAccesoAgenteCompras{
    ...
    public AgenteCompras agenteCompras = new AgenteCompras();
    ...
    public Properties UIAgenteCompras = null;
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        UIAgenteCompras = genericSteps.getPropetiesFile("configuracion\\uielements\\agenteCompras.properties");
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\envio_acuerdo_de_proveedor\\dt_17363.csv");
        contador = 1;
    ...
    public void AC_ModificarAccesoAgenteCompras_17363() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            String gestionarSolicitudes = filaDatos[4];
            String gestionarOrdenesCompra = filaDatos[5];
            String gestionarAcuerdosCompra = filaDatos[6];
            String gestionarNegociaciones = filaDatos[7];
            String gestionarProgramas = filaDatos[8];
            
            
             try{

                    Escenario = "AC_ModificarAccesoAgenteCompras "+Repeticion;
                    ...
                    menuTareasSteps.clickGestionarAgentesCompras(driver, UIMenuTareas, contador, 
                    		Config, Escenario, Navegador); 
                    ...
                    //Paso 10
                    contador++;
                    Pasos.add(contador+".-Seleccionar menu crear");
                    lineasSteps.menuAccionesEditar(driver, UILineas, contador, Config, Escenario, Navegador);
                    
                    //Paso 11
                    contador++;
                    Pasos.add(contador+".-Llenar formulario de agente de compras");
                    agenteCompras.llenarFormAccesoAgente(driver, UIAgenteCompras,
                    		contador, Config, Escenario, Navegador, gestionarSolicitudes, gestionarOrdenesCompra,
                    		gestionarAcuerdosCompra, gestionarNegociaciones, gestionarProgramas);
