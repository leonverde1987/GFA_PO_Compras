...
public class PO_CrearOrdenCompra_ValidarPrivilegioSinAsignarCrearOrdenCompra{
    ...
    @Test
    @SpiraTestCase(testCaseId=16141)
    public void PO_CrearOrdenCompra_ValidarPrivilegioSinAsignarCrearOrdenCompra() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        DataDriven.readNext();
        int Repeticion = 1;
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    Escenario = "PO_CrearOrdenCompra_ValidarPrivilegioSinAsignarCrearOrdenCompra "+Repeticion;
                    ...
                    //Paso 4
                    contador++;
                    Pasos.add(contador+".- Validar que no se muestre el menú Órdenes de compra.");
                    Resultado = menusNavegadorSteps.validarInexistenciaMenu(driver, "Órdenes de compra", Config, UIMenusNavegador, contador, Escenario, Navegador);
