...
public class AP_EnviarAcuerdoModificacion{
    ...
    public void PrepararEjecucion() throws FileNotFoundException, MalformedURLException, InterruptedException{
        ...
        DataDriven = genericSteps.ObtenerDatos("configuracion\\datos\\PO_compras\\acuerdos_proveedor\\dt_17305.csv");
        contador = 1;
    ...
    @Test
    @SpiraTestCase(testCaseId=17305)
